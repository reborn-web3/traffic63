...
export const Hero = () => {
  ...
  return (
    <section
      id="hero"
      className="relative bg-paper pt-28 pb-24 lg:pt-40 lg:pb-32 overflow-hidden"
    >
      <div className="container mx-auto px-5 md:px-10 relative z-10 shrink-0 w-full">
        ...
        <div className="border-t border-line-blue pt-10 pb-16 md:pb-24 lg:pb-32 text-left">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
          {services.map((service, i) => (
            ...
            >
              {/* Header border block */}
              <div className="border-t border-line-blue pt-4 flex justify-between items-center mb-6">
              ...
              {/* Art Card */}
              <div className="relative w-full aspect-[4/5] bg-paper border border-line-blue rounded-2xl overflow-hidden hover:shadow-lg transition-shadow duration-500 mb-6 flex items-center justify-center p-6">
                <Image
                  src={service.src}
                  alt={service.tag}
                  fill
                  sizes="(max-width: 768px) 100vw, 33vw"
                  className="object-contain p-8 hover:scale-105 transition-transform duration-700 dark-theme-image"
                />
              </div>
        ...
        {isVideoOpen && (
          ...
          >
            <motion.div
              ...
              className="relative w-full max-w-4xl bg-paper border border-line-blue rounded-3xl overflow-hidden shadow-2xl p-2"
              onClick={(e) => e.stopPropagation()}
            >
              {/* Close button */}
              <button
                onClick={() => setIsVideoOpen(false)}
                className="absolute top-4 right-4 z-10 w-10 h-10 rounded-full bg-paper border border-line-blue flex items-center justify-center text-ink-dark hover:bg-paper-dark transition-colors cursor-pointer"
