...
const SERVICES: ServiceBlock[] = [
  {
    num: "01",
    tag: "ВЕБ-РАЗРАБОТКА & ДИЗАЙН",
    titlePart1: "Создаем технологичные",
    titleItalic: "и эстетичные",
    titlePart2: "веб-сайты.",
    description: "Разрабатываем современные веб-сервисы и сайты на React/Next.js. Сочетаем премиальный UX/UI-дизайн с надежным, быстрым кодом и бесшовной интеграцией CRM-систем.",
  },
  {
    num: "02",
    tag: "ИИ-ЧАТ-БОТЫ",
  ...
  {
    num: "03",
    tag: "РЕКЛАМА & АНАЛИТИКА",
    titlePart1: "Проектируем окупаемый",
    titleItalic: "трафик",
    titlePart2: "и лиды.",
    description: "Профессиональная настройка рекламы в Яндекс Директ, Telegram Ads и соцсетях в связке со сквозной аналитикой. Оцифровываем воронки и выходим на целевую аудиторию, снижая стоимость лида.",
  },
  {
    num: "04",
    tag: "КОНТЕНТ & SMM",
    titlePart1: "Создаем эстетику",
    titleItalic: "для вашего",
    titlePart2: "бренда.",
    description: "Разрабатываем визуальную стратегию, пишем цепляющие тексты и создаем качественный медиаконтент для соцсетей. Управляем вниманием аудитории и выстраиваем лояльное комьюнити.",
  },
];
